    ...
    <div className="max-w-4xl mx-auto space-y-8 pb-12 relative">
      ...
      <section className="relative h-64 rounded-3xl overflow-hidden group cursor-pointer border border-dark-700">
        ...
        <div className="relative h-full flex flex-col justify-center px-10 space-y-4">
          ...
          >
            Boost Your Odds by <span className="text-primary-500">25%</span> on
            AKO!
          </motion.h1>
          <motion.button
            initial={{ opacity: 0 }}
      ...
      <Link
        to="/virtual-racing"
        className="block relative h-32 rounded-2xl overflow-hidden group cursor-pointer border border-purple-500/30 hover:border-purple-500 transition-colors"
      >
        ...
        <div className="relative z-20 h-full flex items-center justify-between px-8">
          <div className="space-y-2">
            ...
            <p className="text-sm text-gray-400 font-medium">
              Bet on AI-simulated races 24/7. Instant results!
            </p>
          </div>
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-8">
          <div className="max-w-md space-y-4">
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              Don't see what you want to bet on? Use our{" "}
              <span className="text-primary-400 font-bold italic">
                AI-Driven Oddsmaker
              </span>{" "}
              to request a custom bet. Our models will calculate the price
              instantly!
            </p>
            <Link
              to="/custom-bet"
