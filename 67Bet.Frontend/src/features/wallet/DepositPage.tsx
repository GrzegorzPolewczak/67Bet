  ...
  return (
    <div className="max-w-2xl mx-auto space-y-8 pb-12">
      ...
      <div>
        ...
        <p className="text-gray-400 text-sm">Top up your wallet to start betting.</p>
      </div>

      {!clientSecret ? (
        <section className="bg-dark-800 border border-dark-700 rounded-3xl p-8 space-y-6">
          <div>
            <label className="text-xs font-bold text-gray-500 uppercase px-1">Deposit Amount (PLN)</label>
