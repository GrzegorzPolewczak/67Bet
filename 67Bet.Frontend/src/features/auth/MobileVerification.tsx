...
const MobileVerification: React.FC = () => {
    ...
    return (
        <div className="flex flex-col min-h-screen bg-gray-50 p-6">
            <h1 className="text-2xl font-bold text-gray-800 mb-6 text-center">Mobile Verification</h1>
            ...
            <div className="mb-6">
                ...
                <div className="relative border-2 border-dashed border-gray-300 rounded-lg p-6 flex flex-col items-center justify-center bg-white">
                    ...
                    <div className="text-gray-500 text-center">
                        {idCard ? (
                            <span className="text-green-600 font-semibold">{idCard.name}</span>
                        ) : (
            ...
            <div className="mb-8">
                ...
                <div className="relative border-2 border-dashed border-gray-300 rounded-lg p-6 flex flex-col items-center justify-center bg-white">
                    ...
                    <div className="text-gray-500 text-center">
                        {selfie ? (
                            <span className="text-green-600 font-semibold">{selfie.name}</span>
                        ) : (
