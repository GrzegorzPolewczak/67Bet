  ...
  useEffect(() => {
    ...
    const fetchSession = async () => {
      try {
        ...
        const identityUrl =
          import.meta.env.VITE_API_IDENTITY || "http://localhost:5010/api";
      ...
      <div className="flex flex-col items-center justify-center min-h-screen bg-gray-50">
        <div className="p-8 bg-white rounded-lg shadow-lg text-center">
          ...
          <p className="text-gray-600">
            Your identity has been verified successfully. You can now use all
            features.
          </p>
        </div>
      </div>
    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-50">
      <div className="p-8 bg-white rounded-lg shadow-lg text-center max-w-md">
        ...
        <p className="text-gray-600 mb-6">
          Please scan the QR code below using your mobile device to complete the
