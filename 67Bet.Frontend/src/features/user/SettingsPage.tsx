        ...
        <div className="md:col-span-2 space-y-6">
          ...
          <section className="bg-dark-800 border border-dark-700 rounded-3xl p-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-[10px] text-gray-500 mt-1 px-1">Contact support to change your email address.</p>
              </div>
            </div>
          </section>
          ...
          <section className="bg-dark-800 border border-dark-700 rounded-3xl p-6">
            ...
            <div className="space-y-4">
              ...
              <label className="flex items-center justify-between cursor-pointer group">
                <div>
                  <p className="font-bold text-gray-300 group-hover:text-white transition-colors">Marketing Emails</p>
        ...
        <div className="space-y-6">
          <section className="bg-dark-800 border border-dark-700 rounded-3xl p-6">
            ...
            <div className="space-y-4">
              ...
              <button className="w-full py-3 border border-dark-600 hover:bg-dark-700 text-gray-300 rounded-xl text-sm font-bold transition-colors">
                Change Password
              </button>
            </div>
          </section>
