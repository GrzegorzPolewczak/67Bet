...
const sports = [
  ...
  { icon: CircleDot, name: "Roulette", path: "/roulette", color: "text-red-500" },
  {
    icon: Zap,
    name: "Live",
    path: "/sport/Live",
          ...
          <ul className="space-y-1">
            {sports.map((sport) => (
              <li key={sport.name}>
                ...
                >
                  <sport.icon
                    className={`w-5 h-5 ${sport.color || "text-gray-400 group-hover:text-primary-500"}`}
                  />
                  {sport.name}
                </NavLink>
              </li>
        ...
        <div className="bg-gradient-to-br from-primary-600 to-primary-800 rounded-2xl p-4 relative overflow-hidden group cursor-pointer">
          <div className="relative z-10">
            ...
            <p className="text-[10px] text-primary-100">
              Unlock exclusive bonuses and higher limits.
            </p>
          </div>
